...
export const DropDown = ({
	...
	return (
		...
		>
			...
			<div
				className={cn(
					'z-10 min-w-full w-max bg-white rounded-lg shadow absolute mt-2 p-2 text-sm text-gray-700 flex flex-col items-center text-center gap-1 -translate-x-1/2 left-1/2',
					{
						hidden: !isOpen
					}
				)}
